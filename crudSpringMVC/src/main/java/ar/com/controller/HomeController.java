...
public class HomeController {
	...
	public ModelAndView crearSave(@ModelAttribute("person") Persona person) throws IOException {
	...
	public ModelAndView editarInit(@RequestParam("dni") String dni) throws IOException {
	...
	public ModelAndView modificarSave(@ModelAttribute("person") Persona person) throws IOException {
	...
	public ModelAndView eliminar(@RequestParam("dni") String dni) throws IOException {
