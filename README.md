# BootcampJavaAWS2022
#### Tecnologias Vistas:
Servlets, JSP, AWT, Swing, JFX, Spring, Lombok, Spring MVC, JPA, JDBC, SpringBoot, Tomcat, Maven, CXF, Swagger, Log4j.
...
### Usando Spring, Maven, Servlets y .jsp (Almacenando los datos en un .txt).
